...
/// 应用-拦截器注册表
/// </summary>
public class FeishuWebhookInterceptorRegistry
{
    ...
    public void Register(string appKey, Type interceptorType)
    {
        ...
        _registry[appKey].Add(interceptorType);
    }
    ...
    public IReadOnlyList<Type> GetInterceptors(string appKey)
    {
        if (_registry.TryGetValue(appKey, out var interceptors))
        {
    ...
    public bool HasInterceptors(string appKey)
    {
