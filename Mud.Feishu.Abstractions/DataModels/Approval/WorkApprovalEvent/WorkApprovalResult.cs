...
/// <para>事件类型:work_approval</para>
/// <para>使用时请继承：<see cref="WorkApprovalEventHandler"/></para>
/// <para>文档地址：https://open.feishu.cn/document/server-docs/approval-v4/event/common-event/approval-task-event</para>
/// </summary>
[GenerateEventHandler(EventType = FeishuEventTypes.WorkApproval, HandlerNamespace = Consts.HandlerNamespace,
              InheritedFrom = Consts.InheritedFrom)]
public class WorkApprovalResult : IEventResult
{
