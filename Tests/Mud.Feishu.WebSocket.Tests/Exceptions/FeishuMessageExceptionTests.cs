...
/// <summary>
/// FeishuMessageException 消息异常测试类
/// </summary>
public class FeishuMessageExceptionTests
{
    [Fact]
    public void Constructor_ShouldCreateExceptionWithMessage()
    {
        ...
        // Act
        var exception = new FeishuMessageException(message);
    ...
    public void Constructor_ShouldCreateExceptionWithMessageAndInnerException()
    {
        ...
        // Act
        var exception = new FeishuMessageException(message, innerException);
    ...
    {
        // Arrange
        var exception = new FeishuMessageException("Test");
