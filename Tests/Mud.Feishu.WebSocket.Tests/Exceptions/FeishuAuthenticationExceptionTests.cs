...
/// <summary>
/// FeishuAuthenticationException 认证异常测试类
/// </summary>
public class FeishuAuthenticationExceptionTests
{
    [Fact]
    public void Constructor_ShouldCreateExceptionWithMessage()
    {
        ...
        // Act
        var exception = new FeishuAuthenticationException(message);
    ...
    public void Constructor_ShouldCreateExceptionWithMessageAndInnerException()
    {
        ...
        // Act
        var exception = new FeishuAuthenticationException(message, innerException);
    ...
    {
        // Arrange
        var exception = new FeishuAuthenticationException("Test");
    ...
    [Fact]
    public void Exception_ShouldBeCaughtAsFeishuWebSocketExceptionDirectly()
    {
        // Arrange
        var exception = new FeishuAuthenticationException("Test");
        ...
        action.Should().Throw<FeishuWebSocketException>().WithMessage("Test");
    }
}
